...
##### 1.2. Bloque de revisión basica del dataset #####

str(vuelos)
# 'data.frame':	6369482 obs. of  46 variable: (int, Factor)
# Year:	                Year
# Quarter:	            Quarter (1-4)
# Month:	              Month
...
##### 1.3. Bloque de tratamiento de variables #####
